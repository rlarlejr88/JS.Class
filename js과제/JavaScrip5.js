...
​
​function rant(){
    var call = "i hate beets";
    var str = call.toUpperCase();
    var i = 0;
    for (i = 0 ; i < 3; i++ ) {
        console.log(str + "");
        call = up
...
=========================================================== */
​function capitalize(capitalized){
    console.log(capitalized.charAt(0).toUpperCase() + capitalized.slice(1));
}
​capitalize();
​
​
...
=========================================================== */
​function calculateDogAge(human){
    var dog = human * 7;
